...
PY_COMPILE_TARGETS = [
    ...
    "runtime/plugins/tuoguan_core/runtime_performance.py",
    "runtime/plugins/tuoguan_core/capability_facades.py",
    "runtime/plugins/tuoguan_core/execution_receipts.py",
    "runtime/plugins/tuoguan_core/provider_resilience.py",
    "runtime/plugins/tuoguan_core/model_context_budget.py",
    "runtime/plugins/tuoguan_core/turn_fence.py",
    "runtime/plugins/tuoguan_core/turn_trace.py",
    "runtime/plugins/tuoguan_core/teacher_coaching.py",
    ...
    "runtime/plugins/tuoguan_core/repair_task_unified_state_v1.py",
    ...
    "scripts/build_xiaoyou_shadow_model_config.py",
    "scripts/xiaoyou_model_provider_preflight.py",
    "scripts/xiaoyou_shadow_replay_consolidate.py",
...
PYTEST_TARGETS = [
    ...
    "runtime/tests/test_agnes_egress_proxy_v1.py",
    ...
    "runtime/tests/test_build_xiaoyou_shadow_model_config_v1.py",
    "runtime/tests/test_xiaoyou_model_provider_preflight_v1.py",
    "runtime/tests/test_xiaoyou_shadow_replay_consolidate_v1.py",
]
...
def _reliability_contract_gate() -> dict[str, Any]:
    return _run([
        sys.executable,
        str(ROOT / "scripts" / "xiaoyou_reliability_gate.py"),
    ], env=_python_env())
...
def main() -> int:
    ...
    for name, func in (
        ...
        ("reliability_contract_gate", _reliability_contract_gate),
    ):
        result = func()
