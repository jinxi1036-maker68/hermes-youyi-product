...
MODULE_OWNERSHIP = (
    ...
    ModuleOwnership(
        ...
        modules=(
            ...
            "dashboard_auth.py", "dashboard_builder.py", "dashboard_http.py", "dashboard_refresh_runner.py", "dashboard_server.py", "dashboard_workbench_v1.py", "digital_employee_state.py",
            ...
            "growth_plan_exporter.py", "growth_reports.py", "identity.py", "personnel_identity_authority.py", "knowledge.py",
