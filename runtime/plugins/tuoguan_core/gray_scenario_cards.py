...
def generate_gray_trial_start_pack(*, role: str = "", include_examples: bool = True) -> dict[str, Any]:
    ...
    pack = {
        "participants": [
            ...
            {"role": "teacher", "suggested_account": "相关老师", "focus": "自然记录学生表现、任务反馈和使用舒适度。"},
        ],
        "trial_cards": cards,
        ...
        "suggested_trial_order": [
            ...
            "相关老师测试自然记录和老师回复，观察 Hermes 是否保留原意、写后反查、不过度上纲。",
...
def generate_autonomous_acceptance_pack(*, include_teacher: bool = True) -> dict[str, Any]:
    ...
    pack = {
        ...
        "remaining_stages_after_this": [
            {
                ...
                "goal": "根据老板和相关老师真实对话日志，判断是手册经验、状态工具问题、权限边界问题还是表达问题。",
            },
            {
        ...
        "suggested_accounts": [
            ...
            {"role": "teacher", "account": "相关老师账号", "purpose": "自然记录、自然回复、权限边界和使用舒适度。"},
        ],
        "test_sequence": [
            {
                "step": "老板设现实焦点",
            ...
            {
                "step": "老板要求等待",
                "message": "这件事先等相关老师回复，明天上午你再提醒自己看一下。",
